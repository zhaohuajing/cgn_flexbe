...
class SelectInstanceToSceneNameState(EventState):
    ...
    def __init__(self,
                 ...
                 cgn_test_data_dir: str = '/home/csrobot/graspnet_ws/src/contact_graspnet_ros2/contact_graspnet/test_data',
    ...
    def on_enter(self, userdata):
        ...
        try:
            ...
            Logger.loginfo(
                ...
                f"contact_graspnet/test_data/{self._default_scene_name}.npy"
            )
